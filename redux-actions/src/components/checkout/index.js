            ...
            <div className={classes.root}>
                ...
                <ExpansionPanel square expanded={expand === 'client'} onChange={handleChange('client')}>
                    <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />} >
                        ...
                        >
                            {client.success && <span><b>{client.selectedClient.name}</b> | {client.selectedClient.direction}</span>}
                        </SummaryContent>
                    </ExpansionPanelSummary>
                    <ExpansionPanelDetails>
                        <ClientInfo clients={client.clients} updateClients={updateClientList} selectedClient={client.selectedClient} />
                    </ExpansionPanelDetails>
                </ExpansionPanel>
                ...
                <Box display="flex" p={1}>
                    <Button className={classes.btnCheckout} variant="contained" color="secondary" disableElevation 
                        disabled={!cart.success || !client.success || !payment.success}
